...
export default function SideNavigation({
  ...
  return (
    <div className="hidden h-screen w-[16.5rem] flex-shrink-0 flex-col items-center justify-between bg-white dark:bg-kanbanDarkGrey md:flex">
      <div>
        <svg
      ...
      <div className="mb-8 flex w-11/12 flex-col items-start justify-center gap-8">
        ...
        <button
          ...
          type="button"
          className="flex items-center justify-center gap-2 text-kanbanLightGrey"
        >
