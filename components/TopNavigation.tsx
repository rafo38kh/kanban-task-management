...
export default function TopNavigation({
  ...
  return (
    <div className="flex h-full w-full flex-shrink-0 items-center justify-between border border-transparent border-b-kanbanVeryLightGrey bg-white p-4 dark:border-b-kanbanGrey dark:bg-kanbanDarkGrey ">
